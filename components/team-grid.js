...
const TeamGrid = ({ className = "" }) => {
  return (
    <div
      className={`w-[733px] h-[333px] max-w-full z-[3] text-left text-lg text-dark-dark font-body-small-regular mq750:h-auto mq750:min-h-[333] ${className}`}
    >
      <div className="flex flex-row items-start justify-start gap-[27.2px] max-w-full z-[1] mq750:flex-wrap">
